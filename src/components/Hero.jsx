...
export default function Hero() {
  ...
  useEffect(() => {
    ...
    // Main groups for scene structure
    const orbGroup = new THREE.Group()
    const innerGroup = new THREE.Group() // Separate group to handle breathing without breaking GSAP scale
    ...
    // ScrollTrigger UI text fade out
    gsap.to(heroContent, {
      y: -120,
      opacity: 0,
      ease: 'none',
    ...
    const animate = () => {
      ...
      // Breathing animation on inner group
